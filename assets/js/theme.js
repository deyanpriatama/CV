            ...
            if (required === 0) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        $('button[type="submit"]', $this).html('<span><i class="icon icon-Like"></i>Berhasil!</span>');
                        setTimeout(function(){
                            $('button[type="submit"]', $this).html('<span><i class="icon icon-Mail"></i>Kirim</span>');
                        }, 1500);
                    }
                });
            } else {
                $('button[type="submit"]', $this).html('<span><i class="icon icon-Dislike"></i>Gagal!</span>');
                setTimeout(function(){
                    $('button[type="submit"]', $this).html('<span><i class="icon icon-Mail"></i>Kirim</span>');
                }, 1500);
            }
